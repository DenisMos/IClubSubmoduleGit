...
namespace GitView
{
	...
	public partial class MainWindow : Window
	{
		...
		public MainWindow()
		{
			nIcon.Icon = Properties.Resources.non;
			nIcon.Visible = true;
		...
		public async void CheckDiff(object sender)
		{
			...
			try
			{
				...
				{
					case 0:
						nIcon.Icon = Properties.Resources.title;
						break;
					case 1:
						nIcon.Icon = Properties.Resources.mod1;
						this.Icon = ConvertBTS(Properties.Resources.mod1p);
						break;
					case 2:
						nIcon.Icon = Properties.Resources.mod2;
						break;
					case 3:
						nIcon.Icon = Properties.Resources.mod3;
						break;
					case 4:
						nIcon.Icon = Properties.Resources.mod4;
						break;
					case 5:
						nIcon.Icon = Properties.Resources.mod5_;
						break;
					default:
					{
						if(count > 100)
						{
							nIcon.Icon = Properties.Resources._100_;
							ConvertBTS(Properties.Resources._100_p);

						}
						else if(count > 10)
						{
							nIcon.Icon = Properties.Resources._10_;
							ConvertBTS(Properties.Resources._10_p);

						}
						else if(count > 5)
						{
							nIcon.Icon = Properties.Resources.mod5_;
							ConvertBTS(Properties.Resources.mod5p_);
